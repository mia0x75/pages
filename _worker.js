            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    case `/${securePath}/home`:
                        ...
                        if (pwd && !isAuth) return Response.redirect(`${url.origin}/${securePath}/login`, 302);
...
const fetchWgConfig = async (env, warpKeys) => {
    ...
    await env.KV.put('warpConfigs', JSON.stringify(warpConfigs));
}
